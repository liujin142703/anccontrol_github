...
from value_tuning.peak_ams_tuning_UI import Ui_Dialog


class MyPeakFilterTuningDialog(QtWidgets.QDialog, Ui_Dialog):
    ...
    def __init__(self, argv, module):
        ...
        :param module: 功能是否启用
        """
        super(MyPeakFilterTuningDialog, self).__init__()
        self.data = argv
        self.setupUi(self)
        self.set_items()
    ...
    def set_initial_value(self, argv, module):
        ...
        self.R5.setCurrentText(argv['R_high_cut'])
    ...
    def set_data_value(self, i=None):
        ...
        self.data['R_high_cut'] = self.R5.currentText()
...
if __name__ == "__main__":
    data = dict(C1_value='12n', C2_value='12n', C_value_double='27n', R1_value='20k', R2_value='20k',
                R_half_value='10k', R_gain_value=2.2, R_high_cut='0')

    app = QtWidgets.QApplication(sys.argv)
    myWin = MyPeakFilterTuningDialog(data, False)
