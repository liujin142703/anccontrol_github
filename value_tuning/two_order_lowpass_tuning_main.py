...
# -*- coding:utf-8 -*-
# author:dell
# datetime:2019/2/28 17:20

import sys
from PyQt5 import QtCore, QtWidgets
from value_tuning.two_order_lowpass_tuning_UI import Ui_Dialog


class MyTwoOrderLowpassTuningDialog(QtWidgets.QDialog, Ui_Dialog):
    ...
    def __init__(self, argv, module):
        ...
        :param module: 功能是否启用
        """
        super(MyTwoOrderLowpassTuningDialog, self).__init__()
        self.data = argv
        self.setupUi(self)
        self.set_items()
    ...
    def set_items(self):
        ...
        r_items = ['0', '2.2', '2.4', '2.7', '3.0', '3.3', '3.6',
                   ...
                   '390k', '430k', '470k', '510k', '560k', '620k', '680k', '750k', '820k', '910k']
    ...
    def set_initial_value(self, argv, module):
        ...
        self.R3.setCurrentText(str(argv['R3_value']))
    ...
    def set_data_value(self, i=None):
        ...
        self.data['R3_value'] = self.R3.currentText()
...
if __name__ == "__main__":
    data = dict(R1_value='27k', R2_value='27k', R3_value='13k', C1_value='4.7n', C2_value='12n')

    app = QtWidgets.QApplication(sys.argv)
    myWin = MyTwoOrderLowpassTuningDialog(data, True)
